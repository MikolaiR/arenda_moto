...
@section('title', 'Добавить арендатора')

@section('content')
    <h1 class="text-2xl font-semibold text-moto-orange mb-6">Добавить арендатора</h1>

    <form method="POST" action="{{ route('renters.store') }}" class="max-w-xl bg-moto-card p-6 rounded-xl border border-neutral-700 space-y-4">
        @csrf
